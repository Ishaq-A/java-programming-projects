...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            insertContact(statement, "Aman", 6545678, "aman@email.com");
            insertContact(statement, "Joe", 45632, "joemama@email.com");
            insertContact(statement, "Jane", 4829484, "plainjane@email.com");
